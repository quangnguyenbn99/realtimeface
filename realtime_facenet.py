            ...
            while True:
                ...
                if (c % timeF == 0):
                    ...
                    if len(bounding_boxes)>0:
	                    ...
	                    if nrof_faces > 0:
	                        ...
	                        for i in range(0,nrof_faces):
	                            ...
	                            if det[i][0]>=0 and det[i][1]>=0 and det[i][2]<=frame.shape[1]and bounding_boxes[i][3]<=frame.shape[0]:
	                                ...
	                                if best_class_probabilities[0]>=0.95:
	                                    index_text = index_text+1
                                        print ('aaaaaaaaaaaaaaaaaaa%d',index_text)
                                        if index_text % 40 ==10:
    	                                    f_text=open(os.path.join('/home/ubuntu/Desktop/text.txt'),"a")
    	                                    k_random = k_random + 1
    	                                    f_text.write(',%d'%k_random)
    	                                    print ('11111111111111111111111111111%d',index_text) 
                        ...
                        print('Please, look to the camera!!!!')
                ...
                frame1 = cv2.resize(frame, (0,0), fx=1, fy=1)
